...
public class CommandFactory {
    public static Command createCommand(CommandInput input, ArrayList<User> users, ExchangeGraph exchangeRates) {
        switch (input.getCommand()) {
            ...
            case "printTransactions": return new PrintTransactions(input, users);
            ...
            case "setMinBalance":  return new SetMinBalance(input, users);
            ...
            case "setAlias":  return new SetAlias(input, users);
